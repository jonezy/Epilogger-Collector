...
Partial Public Class EpiloggerImage
	...
	<Global.System.Data.Linq.Mapping.AssociationAttribute(Name:="EpiloggerImage_EpiloggerImageMetaData", Storage:="_EpiloggerImageMetaDatas", ThisKey:="ID", OtherKey:="ImageID")>  _
...
Partial Public Class [Event]
	...
	Private _CollectionStartDateTime As Date
    ...
    End Sub
    Partial Private Sub OnCollectionStartDateTimeChanging(value As Date)
    End Sub
	...
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_CollectionStartDateTime", DbType:="DateTime NOT NULL")>  _
	Public Property CollectionStartDateTime() As Date
		Get
			Return Me._CollectionStartDateTime
		End Get
		Set
			If ((Me._CollectionStartDateTime = value)  _
						= false) Then
