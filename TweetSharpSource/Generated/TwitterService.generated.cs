...
#region Implementation
	...
	{	
        ...
        //CB special searched
        public virtual TwitterSearchResult SearchSinceCB(long since_id, string q, int page, int rpp, string lang)
        {
            return WithHammock<TwitterSearchResult>("search", FormatAsString, "?since_id=", since_id, "&q=", q, "&page=", page, "&rpp=", rpp, "&lang=", lang);
        }

        //geocode=37.781157,-122.398720,1mi
        //public virtual TwitterSearchResult SearchSinceCB(long since_id, string q, int page, int rpp, string geocode, string within)
        //{
        //    return WithHammock<TwitterSearchResult>("search", FormatAsString, "?since_id=", since_id, "&q=", q, "&page=", page, "&rpp=", rpp, "&geocode=", geocode, ",", within);
        //}
        
        public virtual TwitterSearchResult SearchSinceCB(long since_id, string q, int page, int rpp, string lang, string geocode, string within)
        {
            return WithHammock<TwitterSearchResult>("search", FormatAsString, "?since_id=", since_id, "&q=", q, "&page=", page, "&rpp=", rpp, "&geocode=", geocode, ",", within, "&lang=", lang);
        }
        //***
