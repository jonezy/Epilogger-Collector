        ...
        public virtual void GetRequestToken(string callback, Action<OAuthRequestToken, TwitterResponse> action)
        {
            ...
            _oauth.BeginRequest(request,
                (req, resp, state) =>
                {
                    ...
                    {
                        action.Invoke(null, new TwitterResponse(resp));
                        return;
                    }
                    ...
                    action.Invoke(requestToken, new TwitterResponse(resp));
                }
                );
        }
                                ...
                                (req, resp, state) =>
                                    {
                                        ...
                                        action.Invoke(accessToken, new TwitterResponse(resp));
                                    }
                );
        }
        ...
        public virtual void GetEchoRequest(string url, Action<string, TwitterResponse> action)
        {
            ...
            client.BeginRequest(request,
                               (req, resp, state) =>
                               {
                                   ...
                                   action.Invoke(content, new TwitterResponse(resp));
                               }
               );
        }
#endif
